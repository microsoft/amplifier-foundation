...
- Before packaging recommendations, read `foundation:docs/BUNDLE_GUIDE.md`: behaviors first; Anchors for new supporting runnable roots. Keep root manifests that anchor repo namespaces.
