...
description: "Use when about to delegate a task to a sub-agent, coordinating multi-step work across agents, or unsure whether to delegate. Covers the full delegation taxonomy: which agents claim which domains, MUST-delegate triggers, context-inheritance patterns, and how to write a delegate prompt."
---
