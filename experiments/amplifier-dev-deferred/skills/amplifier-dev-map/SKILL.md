---
name: amplifier-dev-map
description: "Use when you need to know which Amplifier repo owns which capability, the dependency hierarchy, or where a given module/behavior lives. Maps the ecosystem at the repo level."
---
