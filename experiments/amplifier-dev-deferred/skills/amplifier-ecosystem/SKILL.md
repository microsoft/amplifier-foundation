...
description: "Use when the user asks about Amplifier itself -- what it is, which repos exist, how foundation/core/bundles fit together, or which package owns which capability. Quick map of the ecosystem."
---
