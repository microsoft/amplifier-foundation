...
description: "Use when coordinating two or more parallel agents, fanning work out and merging results, or designing an orchestration that spawns sub-sessions. Covers fan-out/fan-in, isolation, status handling, and result merge patterns."
---
