...
This is the [`behavioral-anchor`](../behavioral-anchor/) experiment extended with an
...
```bash
amplifier bundle add 'git+https://github.com/microsoft/amplifier-foundation@main#subdirectory=experiments/behavioral-anchor-amplifier-dev/behavioral-anchor-amplifier-dev.md' --name behavioral-anchor-amplifier-dev
amplifier bundle use behavioral-anchor-amplifier-dev
```
