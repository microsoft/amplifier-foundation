"""
Agent delegation tool module -- EXP-LEAN FORK.

This is a fork of modules/tool-delegate/ for the exp-lean bundle family.
See experiments/exp-lean/modules/tool-delegate/README.md for fork rationale,
maintenance protocol, and diff vs upstream.
...
Tool Parameters:
- agent: Agent to delegate to (e.g., 'self' or a bundle path like 'namespace:agent-name')
...
Consult the "Available agents" list below for the actual agents registered in
this session and their specialties. If no agents are registered, use agent="self"
or a direct bundle path.
    ...
    def input_schema(self) -> dict:
        ...
        return {
            ...
            "properties": {
                "agent": {
                    "type": "string",
                    "description": "Agent to delegate to (e.g., 'self' or bundle path like 'namespace:agent-name')",
                },
                "instruction": {
                    "type": "string",
